...
p1net <- networkPlot(P, n = 15, Title = "co-occurrence network", type = "fruchterman", 
...
p2net=networkPlot(NetMatrix2, n = 15, Title = "co-citation", type = "fruchterman", labelsize = 1, size = 10, size.cex = T, halo = F, cluster = "leading_eigen",
                remove.isolates = F, curved = 0.9, edgesize = 3,remove.multiple = T, noloops = T, weighted = TRUE)
...
'''ploteo la red'''
p3net=networkPlot(NetMatrix3, n = 20, Title = "Country Collaboration", type = "fruchterman", labelsize = 1, size = 10, size.cex = T, halo = T, cluster = "spinglass",
                remove.isolates = T, curved = 0.9, edgesize = 3,remove.multiple = F, noloops = T, weighted = TRUE)
...
discurso=tm_map(discurso, removeWords, c(stopwords("english"), "behavioral","article","cperceived","zhang", "human", "usa", "kingdom", "korea", "institute", "national", "lee", "china", "univ", "cell", "london", "medical","coronavirus", "gene", "chen", "kong", "hong", "infectious", "animal", "wang", "diseases", "veterinary", "center", "centre", "college", "sciences", "school", "protein", "public", "control", "state", "liu", "clinical", "chinese", "van", "department", "affiliated", "united", "universit", "kim", "viral", "california", "vaccine"))

############### DATA FRAME DE PALABRAS CON SU FRECUENCIA

'''Creamos matriz de letras'''
letras= TermDocumentMatrix(discurso)
findFreqTerms(letras, lowfreq=6)
...
barplot(dataletras[1:15,]$freq, las = 2, names.arg = dataletras[1:15,]$word,
...
molesten en el resultado. PDT: hay que cambiar la lista de 
palabras que es de otra bibliometría'''
discurso=tm_map(discurso, removeWords, c(stopwords("english"), "human", "usa", "kingdom", "korea", "institute", "national", "china", "univ", "cell", "london", "medical","coronavirus", "gene", "kong", "hong", "infectious", "animal", "diseases", "veterinary", "center", "centre", "college", "sciences", "school", "protein", "public", "control", "state", "clinical", "chinese", "department", "affiliated", "united", "universit", "viral", "california", "vaccine"))
